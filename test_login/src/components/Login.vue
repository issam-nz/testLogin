...
export default {
    ...
    methods: {
        async handleSubmit() {
            ...
            // console.log(response.data.access_token);
            // console.log(response.data.usuario)
            const usuario = this.convertToUsuario(response.data);
            ...
            // localStorage.setItem('usuario', response.data.usuario); //hay que guardar los datos del usuario uno por uno
            // this.$router.push('/'); // para ir directamente a la pagina global, o a otra
        },
        convertToUsuario(data) {
            const usuario = {
                    id: null,
                    nombre: '',
                    apellido: '',
            ...
            usuario.admin = data.usuario.admin;
